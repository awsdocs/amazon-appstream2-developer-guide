...
If you are using images that are created from base images dated prior to 2017\-07\-24, you can view a compatible version of this tutorial by downloading the PDF file [appstream2\-dg\-2017\-07\-23\.pdf](http://awsdocs.s3.amazonaws.com/AppStream2/appstream2-dg-2017-07-23.pdf)\. 
...
+ [Step 6: Clean Up](#tutorial-image-builder-finish)
...
1. Install apps by browsing to an application website or other download source\. Complete the application's own installation process before moving to the next step\.
...
+ Verify that the applications you've added start correctly\. To do this, start a new Windows session as a user who has similar access rights as your end users\. 
  ...
  1. To log in as a local test user, choose **Test User**\. To log in as an Active Directory user, choose **Directory User**, and provide the username and password of the user to log in as\. Choose **Log in**\.
...
1. Return to the console and navigate to **Images**, **Image Registry**\. Verify that your new image appears in the list\.
   ...
   Optionally, you can apply one or more tags to help manage the image\. Choose **Tags**, choose **Add/Edit Tags**, choose **Add Tag**, specify the key and value for the tag, and then choose **Save**\. For more information, see [Tagging Your Amazon AppStream 2\.0 Resources](tagging-basic.md)\.
...
## Step 6: Clean Up<a name="tutorial-image-builder-finish"></a>
